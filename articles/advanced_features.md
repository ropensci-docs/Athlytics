...
This vignette demonstrates the advanced features of Athlytics for
...
sequence is resampled in overlapping weekly blocks (preserves
within-week correlation) 2. ACWR is recalculated for each bootstrap
sample (B = 200 iterations) 3. 2.5th and 97.5th percentiles form the 95%
confidence band
