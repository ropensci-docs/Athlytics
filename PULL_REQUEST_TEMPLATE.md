...
If yes, please describe: - What breaks: - How to migrate:
...
Changes are backwards compatible (or breaking changes are justified and
documented)
...
Conduct](https://docs.ropensci.org/Athlytics/CODE_OF_CONDUCT.md).
